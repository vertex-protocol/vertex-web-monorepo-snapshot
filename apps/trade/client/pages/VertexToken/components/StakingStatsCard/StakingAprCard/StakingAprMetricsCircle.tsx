...
import aprCircleBg from 'client/pages/VertexToken/components/StakingStatsCard/StakingAprCard/assets/staking-apr-circle-bg.svg';
...
export function StakingAprMetricsCircle({
  className,
  topMetric,
  bottomMetric,
}: WithClassnames<{
