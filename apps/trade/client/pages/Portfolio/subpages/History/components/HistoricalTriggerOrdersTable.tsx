...
const columnHelper = createColumnHelper<HistoricalTriggerOrder>();
...
export function HistoricalTriggerOrdersTable() {
  ...
  const columns: ColumnDef<HistoricalTriggerOrder, any>[] = useMemo(() => {
    return [
      ...
      columnHelper.accessor('status', {
        id: 'statusType',
        header: ({ header }) => <HeaderCell header={header}>Status</HeaderCell>,
        cell: (context) => (
