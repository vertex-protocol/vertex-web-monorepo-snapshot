...
} from '../hooks/useHistoricalLiquidationsTable';
import { LiquidationAmountInfoCell } from './cells/liquidation/LiquidationAmountInfoCell/LiquidationAmountInfoCell';

const columnHelper = createColumnHelper<HistoricalLiquidationEvent>();
...
export function HistoricalLiquidationsTable() {
  ...
  const columns: ColumnDef<HistoricalLiquidationEvent, any>[] = useMemo(() => {
    return [
        ...
        cell: (context) => {
          return (
            <TableCell className="pointer-events-auto pr-4">
              ...
              >
                <Icons.RxMagnifyingGlass size={20} />
              </TextButton>
            </TableCell>
          );
        },
