...
interface PortfolioChartQueryTimes {
 ...
 */
export function usePortfolioChartQueryTimes(timespan: PortfolioChartTimespan) {
  const { data: subaccountCreationTime } = useSubaccountCreationTime();

  return useMemo((): PortfolioChartQueryTimes | undefined => {
