...
import { BnbLogoIcon } from 'client/modules/collateral/deposit/components/DepositEntrypointButton/icons/BnbLogoIcon';
import { EthLogoIcon } from 'client/modules/collateral/deposit/components/DepositEntrypointButton/icons/EthLogoIcon';
import { MastercardLogoIcon } from 'client/modules/collateral/deposit/components/DepositEntrypointButton/icons/MastercardLogoIcon';
import { OptimismLogoIcon } from 'client/modules/collateral/deposit/components/DepositEntrypointButton/icons/OptimismLogoIcon';
import { VisaLogoIcon } from 'client/modules/collateral/deposit/components/DepositEntrypointButton/icons/VisaLogoIcon';
...
/**
 * Entrypoint button for the deposit flow:
 * - If fun.xyz is enabled, then renders a button that opens the fun.xyz deposit flow
 * - Otherwise, renders a dropdown for: direct deposit, bridge, & onramp
 */
export function DepositEntrypointButton({
  triggerClassName,
  contentClassName,
  ...
  const { isBridgeEnabled, isOnrampEnabled, isFunkitEnabled } =
    useEnabledFeatures();
  ...
  if (isFunkitEnabled) {
    return (
      <CardButton
        ...
        // Deposit dialog handles conditional rendering of the funkit deposit flow
