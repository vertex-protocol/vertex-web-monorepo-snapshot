import { OrderConsoleLocationButton } from 'client/modules/accountCenter/components/AccountCenterSettingsContent/OrderConsoleLocationButton';
...
export function TradingConsolePosition() {
  ...
  return (
    <div className="flex flex-col gap-y-2">
      <div className="text-text-primary text-sm">Trading Console Position</div>
