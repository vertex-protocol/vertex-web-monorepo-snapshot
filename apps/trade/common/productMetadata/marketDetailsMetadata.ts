...
export const WBTC_SPOT_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/bitcoin/',
};
...
export const WETH_SPOT_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/ethereum/',
};
...
export const ARB_SPOT_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/arbitrum/',
};
...
export const USDT_SPOT_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/tether/',
};

export const WMNT_SPOT_MARKET_DETAILS: MarketDetailsMetadata = {
  description:
    'Mantle is a new type of Layer 2 blockchain aiming to bring hyper-scale to Ethereum by taking a modular chain approach.',
  moreDetailsLink: 'https://coinmarketcap.com/currencies/wrapped-mantle/',
};
...
export const VRTX_SPOT_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/vertex-protocol/',
};

export const METH_SPOT_MARKET_DETAILS: MarketDetailsMetadata = {
  description: `Mantle LSP is a permissionless and non-custodial ETH liquid staking protocol deployed on Ethereum L1 and governed by Mantle.`,
  moreDetailsLink: 'https://coinmarketcap.com/currencies/mantle-staked-ether/',
};
...
export const BNB_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/bnb/',
};
...
export const XRP_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/xrp/',
};
...
export const SOL_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/solana/',
};
...
export const MATIC_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/polygon/',
};
...
export const SUI_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/sui/',
};
...
export const OP_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/optimism-ethereum/',
};
...
export const APT_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/aptos/',
};
...
export const LTC_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/litecoin/',
};
...
export const BCH_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/bitcoin-cash/',
};
...
export const COMP_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/compound/',
};
...
export const MKR_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/maker/',
};
...
export const MPEPE_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/pepe/',
};
...
export const DOGE_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/dogecoin/',
};
...
export const LINK_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/chainlink/',
};
...
export const DYDX_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/dydx/',
};
...
export const CRV_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/curve-dao-token/',
};
...
export const TIA_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/celestia/',
};
...
export const PYTH_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/pyth-network/',
};
...
export const JTO_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/jito/',
};
...
export const AVAX_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/avalanche/',
};
...
export const INJ_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/injective/',
};
...
export const SNX_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/synthetix/',
};
...
export const ADA_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/cardano/',
};
...
export const MEME_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/meme/',
};
...
export const IMX_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/immutable-x/',
};
...
export const SEI_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/sei/',
};
...
export const STX_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/stacks/',
};
...
export const NEAR_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/near-protocol/',
};
...
export const BLUR_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/blur-token/',
};
...
export const LDO_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/lido-dao/',
};
...
export const FIL_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/filecoin/',
};
...
export const WLD_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/worldcoin-org/',
};
...
export const ICP_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/internet-computer/',
};
...
export const DOT_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/polkadot-new/',
};
...
export const TRX_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/tron/',
};
...
export const GALA_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/gala/',
};
...
export const ATOM_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/cosmos/',
};
...
export const APE_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/apecoin-ape/',
};
...
export const JUP_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/jupiter-ag/',
};

export const GM30_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  description: `The “GMCI 30” represents a selection of the top 30 cryptocurrencies, showcasing the giants of the digital asset world.`,
  moreDetailsLink: 'https://www.gmci.co/indices/gmci-30',
};

export const GMMEME_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  description: `The "GMCI Meme" contains the leading meme coins by market capitalization, capturing the unique essence and humor intrinsic to crypto culture and web3 communities`,
  moreDetailsLink: 'https://www.gmci.co/indices/gmci-meme',
};

export const TON_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  description: `Toncoin (TON) is the native cryptocurrency of the decentralized layer-1 blockchain, The Open Network (TON). The TON blockchain is open-sourced and supported by many network contributors, including the Switzerland-based non-profit organization, the TON Foundation.`,
  moreDetailsLink: 'https://coinmarketcap.com/currencies/toncoin/',
};

export const FTM_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  ...
  moreDetailsLink: 'https://coinmarketcap.com/currencies/fantom/',
};

export const WIF_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  description: `Popular meme Dogwifhat vibes wif frens onchain.`,
  moreDetailsLink: 'https://coinmarketcap.com/currencies/dogwifhat/',
};

export const ONDO_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  description: `ONDO token holders are entrusted with shaping the future of the Ondo DAO so that it continues to pursue its mission to democratize access to institutional-grade finance.`,
  moreDetailsLink: 'https://coinmarketcap.com/currencies/ondo-finance/',
};

export const ENA_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  description: `Ethena is a synthetic dollar protocol built on Ethereum that will provide a crypto-native solution for money that is not reliant on traditional banking system infrastructure.`,
  moreDetailsLink: 'https://coinmarketcap.com/currencies/ethena/',
};

export const MNT_PERP_MARKET_DETAILS: MarketDetailsMetadata = {
  description: `Mantle Network is an L2 technology stack for scaling Ethereum, and is the first core product of Mantle Ecosystem.`,
  moreDetailsLink: 'https://coinmarketcap.com/currencies/mantle/',
};
