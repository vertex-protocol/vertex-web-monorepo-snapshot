...
export const BTC_PERP_METADATA: PerpProductMetadata = {
  ...
  marketCategories: new Set(['perp', 'chain']),
};
...
export const POL_PERP_METADATA: PerpProductMetadata = {
  symbol: 'POL',
  icon: TOKEN_ICONS.pol,
  marketName: 'POL-PERP',
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'chain']),
};
...
export const COMP_PERP_METADATA: PerpProductMetadata = {
  ...
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'defi']),
};
...
export const MPEPE_PERP_METADATA: PerpProductMetadata = {
  ...
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'meme']),
};
...
export const GMCI30_PERP_METADATA: PerpProductMetadata = {
  ...
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'index']),
};
...
export const S_PERP_METADATA: PerpProductMetadata = {
  symbol: 'S',
  icon: TOKEN_ICONS.s,
  marketName: 'S-PERP',
  quoteProductId: QUOTE_PRODUCT_ID,
...
export const BLAST_PERP_METADATA: PerpProductMetadata = {
  symbol: 'BLAST',
  icon: TOKEN_ICONS.blast,
  marketName: 'BLAST-PERP',
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'chain']),
};

export const AAVE_PERP_METADATA: PerpProductMetadata = {
  symbol: 'AAVE',
  icon: TOKEN_ICONS.aave,
  marketName: 'AAVE-PERP',
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'defi']),
};

export const EIGEN_PERP_METADATA: PerpProductMetadata = {
  symbol: 'EIGEN',
  icon: TOKEN_ICONS.eigen,
  marketName: 'EIGEN-PERP',
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'defi']),
};

export const ZRO_PERP_METADATA: PerpProductMetadata = {
  symbol: 'ZRO',
  icon: TOKEN_ICONS.zro,
  marketName: 'ZRO-PERP',
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'defi']),
};

export const BRETT_PERP_METADATA: PerpProductMetadata = {
  symbol: 'BRETT',
  icon: TOKEN_ICONS.brett,
  marketName: 'BRETT-PERP',
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'meme']),
};

export const DEGEN_PERP_METADATA: PerpProductMetadata = {
  symbol: 'DEGEN',
  icon: TOKEN_ICONS.degen,
  marketName: 'DEGEN-PERP',
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'meme']),
};

export const SCR_PERP_METADATA: PerpProductMetadata = {
  symbol: 'SCR',
  icon: TOKEN_ICONS.scr,
  marketName: 'SCR-PERP',
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'defi']),
};

export const GOAT_PERP_METADATA: PerpProductMetadata = {
  symbol: 'GOAT',
  icon: TOKEN_ICONS.goat,
  marketName: 'GOAT-PERP',
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'meme']),
};

export const TRUMP_PERP_METADATA: PerpProductMetadata = {
  symbol: 'TRUMP',
  icon: TOKEN_ICONS.trump,
  marketName: 'TRUMP-PERP',
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'meme']),
};

export const BERA_PERP_METADATA: PerpProductMetadata = {
  symbol: 'BERA',
  icon: TOKEN_ICONS.bera,
  marketName: 'BERA-PERP',
  quoteProductId: QUOTE_PRODUCT_ID,
  marketCategories: new Set(['perp', 'chain']),
};
